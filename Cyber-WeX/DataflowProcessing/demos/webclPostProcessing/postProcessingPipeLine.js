    ...
    (function () {
        ...
        XML3D.createClass(WebCLPass, webgl.BaseRenderPass, {
            init: function (context) {
                ...
                this.clBufIn = this.clCtx.createBuffer(WebCL.MEM_READ_ONLY, this.bufSize); //Buffer in WebCL Ctx
                this.clBufOut = this.clCtx.createBuffer(WebCL.MEM_WRITE_ONLY, this.bufSize); //Buffer in WebCL Ctx
            },
